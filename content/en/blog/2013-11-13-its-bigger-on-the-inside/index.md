---
title: "It's bigger on the inside — fitting a lot into a small space"
date: 2013-11-13
slug: "its-bigger-on-the-inside"
translationKey: "its-bigger-on-the-inside-viel-untergebracht-auf-kleinem-raum"
categories:
  - "Organisation"
---
At the November plenary we decided to finally tackle the problem of overfull tables and
overflowing boxes. So we have now bought a few extra shelves and been given another table. At
...
are now stored underneath; the table itself is taken up by the T-shirt press and the laptop
used to drive the plotter.

That means no more constantly packing the T-shirt equipment away. Only the plotter has to be
...
new shelves we could finally re-sort everything standing on the table and on the floor, label
it and pack it into the shelves. Since then the table surface (right in the picture) is free
...
The manuals for sewing machine maintenance and the membership and mailing list forms are kept
there too, so that while socialising on the bridge you can sort out the organisational side
over a biscuit.

New lights will be installed shortly, to brighten the machine room a little and make it even
more inviting. Do come by to get an impression for yourself, or to try out the new T-shirt
print shop!
